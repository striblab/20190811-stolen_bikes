...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190802-stolen-bikes">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190802-stolen-bikes/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190802-stolen-bikes/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190802-stolen-bikes/",
      "url": "http://static.startribune.com/news/projects/all/20190802-stolen-bikes/"
    }
  }
}
```
